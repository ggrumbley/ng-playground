...
(function (window, context, undefined) {
    var _hierarchyNodePathSelector = AlphaClass.create({
        initialize: function (/*string*/input, /*HierarchyTypeKind*/kind, /*string*/companyId, /*string*/currentNodeGuid, /*Func<Event, string, bool>*/pathChanged) {
            var _this = this;
            this._kind = kind;
        ...
        setCurrentNode: function (nodeGuid) {
           ...
           // if (this._currentNode == nodeGuid) return;
            ...
            if (nodeGuid == null || nodeGuid == undefined || nodeGuid == "") {
                _this._getRoots(function (nodes) { $(_this._pathSelectorControl).pathSelector("parts", nodes); });
            } else {
        ...
        setCurrentCompany: function (companyId) {
            var _this = this;
            this._companyId = companyId;
            this._getRoots(function (nodes) { $(_this._pathSelectorControl).pathSelector("parts", nodes); });        
        },
        ...
        _getPathFromGuid: function (/*string*/guid, callbackWhenDone) {
            ...
            if (this._companyId == undefined || guid == undefined) callbackWhenDone([]);
                ...
                Fr.Alphasystem.Report.Web.ajaxHelper.post('HierarchyNode/GetPathOfNode', { nodeGuid: guid, companyId: this._companyId })
        ...
        _getChildren: /*void*/function (/*string*/path, /*string[]*/tree, /*Action<List<Option>>*/callbackWhenDone) {
            var _this = this;
            Fr.Alphasystem.Report.Web.ajaxHelper.post('HierarchyNode/GetHierarchyNodeChildren', { nodeGuid: tree[tree.length - 1], companyId: this._companyId })
                                                .done(function (result) {
                                                    callbackWhenDone(_this._toPathSelectorOptions(result));
                                                });
        },
        ...
        _getRoots: /*void*/function (/*Action<List<Option>>*/callbackWhenDone) {
            ...
            if (this._companyId == undefined) callbackWhenDone([]);
                ...
                Fr.Alphasystem.Report.Web.ajaxHelper.post('HierarchyNode/GetHierarchyNodeRoots', { companyId: this._companyId, kind: this._kind })
                                                .done(function (result) {
                                                    callbackWhenDone(_this._toPathSelectorOptions(result));
                                                });
            }
    ...
    window.Fr.Alphasystem.Report.Web.Controls.HierarchyNodePathSelector = _hierarchyNodePathSelector;
