    ...
    tinymce.create('tinymce.dom.DOMUtils', {
        ...
        loadCSS: function (u) {
            ...
            each(u.split(','), function (u) {
                ...
                if (isIE && !tinymce.isIE11 && d.documentMode && document.createStyleSheet) {
                    (function (c) {
                        c[c.length - 1].addImport(tinymce._addVer(u))
                    })(document.styleSheets);

                    //link = document.createStyleSheet(tinymce._addVer(u));
                } else {
