 ...
 */ (function(window, document, undefined) {
    ...
    }).directive('bsAlert', ['$window', '$location', '$sce', '$alert',
            ...
            return function(picker) {
                ...
                var views = [{
                    ...
                    build: function() {
                        ...
                        var firstDate = new Date(+firstDayOfMonth - mod(firstDayOfMonth.getDay() - options.startWeek, 7) * 86400000),
                            firstDateOffset = firstDate.getTimezoneOffset();
                        // Handle daylight time switch
                        if (firstDateOffset !== firstDayOfMonthOffset) firstDate = new Date(+firstDate + (firstDateOffset - firstDayOfMonthOffset) * 60000);
                        var days = [],
                            day;
                        for (var i = 0; i < 42; i++) {
                            // < 7 * 6
                    ...
                    onKeyDown: function(evt) {
                        ...
                        var newDate;
                        if (evt.keyCode === 37) newDate = new Date(actualTime - 1 * 86400000);
                        else if (evt.keyCode === 38) newDate = new Date(actualTime - 7 * 86400000);
                        else if (evt.keyCode === 39) newDate = new Date(actualTime + 1 * 86400000);
                        else if (evt.keyCode === 40) newDate = new Date(actualTime + 7 * 86400000);
    ...
    }).directive('bsDropdown', ['$window', '$location', '$sce', '$dropdown',
    ...
    angular.module('mgcrea.ngStrap.modal', ['mgcrea.ngStrap.helpers.dimensions']).provider('$modal', function() {
        ...
        function($window, $rootScope, $compile, $q, $templateCache, $http, $animate, $timeout, $sce, dimensions) {
            ...
            function ModalFactory(config) {
                ...
                if( options.data ) angular.extend(scope, options.data);
    ...
    }).directive('bsModal', ['$window', '$location', '$sce', '$modal',
    ...
    }).directive('bsPopover', ['$window', '$location', '$sce', '$popover',
